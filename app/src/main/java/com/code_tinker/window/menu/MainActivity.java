...
import com.code_tinker.window.menu.adapter.MainItemAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        rlClick.setOnClickListener(v -> PopupMenuUtil.getInstance()._show(context, ivImg));
    }
    ...
    public void setAdapter() {
        if (adapter == null) {
            adapter = new MainItemAdapter(context, data);
